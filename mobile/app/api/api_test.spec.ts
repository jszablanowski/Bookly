...
describe("BookingsControllerApi", () => {
  ...
  test("deleteBookingUsingDELETE", () => {
    ...
    return expect(
      instance.deleteBookingUsingDELETE(bookingId, {})
    ).resolves.toBe(null);
  });
  test("getBookingUsingGET", () => {
    const bookingId: number = 789;
    return expect(instance.getBookingUsingGET(bookingId, {})).resolves.toBe(
      null
    );
  });
  test("getCarsBookingsUsingGET", () => {
    ...
    return expect(
      instance.getCarsBookingsUsingGET(page, size, filter, sort, {})
    ).resolves.toBe(null);
  });
  test("getFlatsBookingsUsingGET", () => {
    ...
    const sort: string = "sort_example";
    return expect(
      instance.getFlatsBookingsUsingGET(page, size, filter, sort, {})
    ).resolves.toBe(null);
  });
  test("getParkingsBookingsUsingGET", () => {
    ...
    const sort: string = "sort_example";
    return expect(
      instance.getParkingsBookingsUsingGET(page, size, filter, sort, {})
    ).resolves.toBe(null);
  });
  test("getUserCarsUsingGET", () => {
    ...
    const sort: string = "sort_example";
    return expect(
      instance.getUserCarsUsingGET(page, size, filter, sort, {})
    ).resolves.toBe(null);
  });
  test("getUserFlatsUsingGET", () => {
    ...
    const sort: string = "sort_example";
    return expect(
      instance.getUserFlatsUsingGET(page, size, filter, sort, {})
    ).resolves.toBe(null);
  });
  test("getUserParkingsUsingGET", () => {
    ...
    const sort: string = "sort_example";
    return expect(
      instance.getUserParkingsUsingGET(page, size, filter, sort, {})
    ).resolves.toBe(null);
  });
...
describe("ItemsControllerApi", () => {
  ...
  test("getFlatItemsUsingGET", () => {
    ...
    const text: string = "text_example";
    return expect(
      instance.getFlatItemsUsingGET(page, city, sorted, street, text, {})
    ).resolves.toBe(null);
  });
  test("getParkingItemsUsingGET", () => {
    ...
    return expect(
      instance.getParkingItemsUsingGET(page, pageSize, active, {})
    ).resolves.toBe(null);
  });
});
...
describe("UsersControllerApi", () => {
  ...
  test("disableUserUsingDELETE", () => {
    ...
    return expect(instance.disableUserUsingDELETE(userId, {})).resolves.toBe(
      null
    );
  });
  test("getUsersUsingGET", () => {
    ...
    const active: boolean = true;
    return expect(
      instance.getUsersUsingGET(page, size, active, {})
    ).resolves.toBe(null);
  });
