...
const BASE_PATH = "//localhost:8090/".replace(/\/+$/, "");
...
export const BookingsControllerApiFetchParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getUserBookingsUsingGET(options: any = {}): FetchArgs {
...
export const BookingsControllerApiFp = function (
  ...
  return {
    ...
    getBookingUsingGET(
      bookingId: number,
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<BookingResponse> {
      const localVarFetchArgs = BookingsControllerApiFetchParamCreator(
        configuration
    ...
    getUserBookingsUsingGET(
      ...
      fetch?: FetchAPI,
      basePath?: string
    ) => Promise<Array<BookingResponse>> {
      const localVarFetchArgs =
        BookingsControllerApiFetchParamCreator(
          configuration
        ).getUserBookingsUsingGET(options);
      return (
        fetch: FetchAPI = portableFetch,
        basePath: string = BASE_PATH
      ) => {
...
export const BookingsControllerApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getUserBookingsUsingGET(options?: any) {
      return BookingsControllerApiFp(configuration).getUserBookingsUsingGET(
        options
      )(fetch, basePath);
    },
  };
...
export class BookingsControllerApi extends BaseAPI {
   ...
   * @memberof BookingsControllerApi
   */
  public getUserBookingsUsingGET(options?: any) {
    return BookingsControllerApiFp(this.configuration).getUserBookingsUsingGET(
      options
    )(this.fetch, this.basePath);
  }
}
